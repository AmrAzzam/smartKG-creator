...
``` 
docker run --name familyPartioning -v /host/path/target:/file/path/within/container  smartkg-creator getFamilies -s part_friends-_ -m 100 -e friends /mnt/hdts/friends2023.hdt
```
